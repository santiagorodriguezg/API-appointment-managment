...
class RoomAPITestCase(APITestCase):
    ...
    def test_list_chat_rooms_by_owner(self) -> None:
        ...
        url = f'/{API_ENDPOINT_V1}/users/{self.user_owner.username}/rooms/'
        ...
        url = f'/{API_ENDPOINT_V1}/users/{self.user_receiver_1.username}/rooms/'
        response = self.client.get(url)
    ...
    def test_list_chat_rooms_by_receiver(self):
        ...
        # Listar salas de chat asociadas a otro usuario
        url = f'/{API_ENDPOINT_V1}/users/{self.user_receiver_2.username}/rooms/'
        response = self.client.get(url)
