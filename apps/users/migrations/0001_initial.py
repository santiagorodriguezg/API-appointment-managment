    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identification_number', models.CharField(error_messages={'unique': 'Ya existe un contacto con este número de identificación.'}, max_length=10, unique=True, validators=[django.core.validators.MinLengthValidator(limit_value=6, message='Su identificación debe tener al menos 6 caracteres.')], verbose_name='número de identificación')),
                ...
                ('email', models.EmailField(blank=True, error_messages={'unique': 'Ya existe un contacto con este correo electrónico.'}, max_length=60, null=True, unique=True, verbose_name='correo electrónico')),
